[![Build Status](https://travis-ci.org/itsbenweeks/genomic-sequence-visualizer.svg?branch=master)](https://travis-ci.org/itsbenweeks/genomic-sequence-visualizer)
